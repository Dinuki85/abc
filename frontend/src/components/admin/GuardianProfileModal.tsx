      ...
      <div className="flex min-h-full items-center justify-center">
        <div className="bg-white rounded-[3rem] w-full max-w-6xl shadow-2xl border border-white/20 overflow-hidden animate-in zoom-in-95 duration-500 flex flex-col h-[80vh]">
          ...
          <div className="p-6 border-t border-gray-100 flex justify-end gap-4 bg-slate-50/50 flex-shrink-0">
             ...
             <Button 
               type="submit" 
               form="guardian-profile-form"
               className="h-12 px-12 rounded-xl bg-pink-500 hover:bg-pink-600 text-white font-bold shadow-xl shadow-pink-500/30 flex items-center gap-2"
               isLoading={isSaving}
             >
               <Save size={18} />
               Save Profile
  ...
  return (
    <div className="space-y-2">
      ...
      <textarea 
        {...props} 
        rows={3}
        className="w-full p-4 rounded-xl border border-gray-200 bg-slate-50/50 focus:bg-white focus:outline-none focus:ring-4 focus:ring-pink-500/10 focus:border-pink-500 transition-all shadow-inner font-bold text-slate-700 text-sm custom-scrollbar"
      />
    </div>
  );
}
