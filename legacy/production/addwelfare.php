...
?>
	...
	<head>
		...
		<title>Student Welfare Payment</title>
					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student Welfare Payment</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Welfare Amount<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
