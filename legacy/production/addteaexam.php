...
?>
	...
	<head>
		...
		<title>Staff Registration to Exam</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Staff Registration to Exam</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Staff to Exam</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Exam ID <span class="required">*</span>
												</label>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Staff ID <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Staff Position </label>
											<div class="col-md-6 col-sm-6 ">
