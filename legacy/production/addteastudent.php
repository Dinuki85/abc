...
?>
	...
	<head>
		...
		<title>Student Allocate to Special Task </title>
							...
							<div class="menu_section">
								...
								<ul class="nav side-menu">
									...
									<li><a><i class="fa fa-user"></i> Staff <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
											<li><a href="Teacher.php">Registration</a></li>
											<li><a href="searchTeacher.php">Search</a></li>
											<li><a href="updateTeacher.php">Update</a></li>
									...
									<ul class="nav child_menu">
											<li><a href="sport.php">Registration</a></li>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Student Allocate to Special Task </h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student to Special Task </small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Task ID <span class="required">*</span>
												</label>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Task Details<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="clubid" required="required" class="form-control ">
												</div>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Staff ID <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="clubid" required="required" class="form-control ">
												</div>
										...
										<div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Student Position </label>
											<div class="col-md-6 col-sm-6 ">
											    <select name="" id="gicatagoryd" class="form-control">
													<option value="0">Select a Catergory </option>
													<option value="1">Leader</option>
													<option value="2">Special Participation</option>
