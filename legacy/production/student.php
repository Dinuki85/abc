					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Student <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="ind" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="specialneed" class="form-control" type="text" name="Tempory-address">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="hmno" class="form-control" type="text" name="Home-no">
											</div>
										</div>
										<div class="item form-group">
											<label for="sec" class="col-form-label col-md-3 col-sm-3 label-align">Mobile No </label>
											<div class="col-md-6 col-sm-6 ">
												<input id="mbno" class="form-control" type="text" name="sec-no">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="reset" onclick="myFunction();">Reset</button>
												<button class="btn btn-success" type="submit" onclick="createStudent();">Submit</button>
											</div>
										</div>
									</div>
								</div>
...
document.getElementById("specialneed").value = '';
document.getElementById("paddress").value = '';
document.getElementById("taddress").value = '';
document.getElementById("birthday").value = '';
document.getElementById("emno").value = '';
document.getElementById("wtno").value = '';
document.getElementById("hmno").value = '';
