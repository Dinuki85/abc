...
?>
    ...
    <head>
        ...
        <title>Student Name List in a Co Activity</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Student List  in a Co Activity</h3>
                            </div>
                                ...
                                <div class="title_right">
                                    <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                                        <div class="input-group">
                                            <input type="text" class="form-control" required id="search" name="search" value="<?php if(isset($_POST['submit'])){    echo $_POST['search']; }?>" placeholder="Search Co Activity ID...">
                            ...
                            <tbody>
                                ...
                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $item['initial']; ?></td>
                                                <?php
                                                if (!empty($item['special_need'])) {
                                                ?><td><?php echo $item['special_need']; ?></td>
