          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Guardian <small>Basic Information</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="nic">Guardian NIC <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="nic" required="required" class="form-control ">
                        </div>
                      </div>
                    ...
                    <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="emno" class="form-control" type="text" name="emergency-no">
											</div>
										</div>
                    <div class="item form-group">
											<label for="wtno" class="col-form-label col-md-3 col-sm-3 label-align">Whatsapp No</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="wtno" class="form-control" type="text" name="Whatsapp-no">
											</div>
										</div>
                    <div class="item form-group">
                        <label for="job" class="col-form-label col-md-3 col-sm-3 label-align">Ocupation<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 ">
                      ...
                      <div class="item form-group">
                        <label for="std_id1" class="col-form-label col-md-3 col-sm-3 label-align">Student <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 ">
                          <select name="" id="std" class="form-control">
                            
                            <option value="0" >Select Student</option>
                            <?php 
                      
                      $s_st = Database::search("SELECT * FROM `student`");
                      $st_rows = $s_st->num_rows;

                      for($x = 0; $x<$st_rows;$x++){
                        $st_rs = $s_st->fetch_assoc();
                        ?>

                        <option value="<?php echo $st_rs['idstudent']; ?>"><?php echo $st_rs['index'] ?></option>
                      ...
                      <div class="item form-group">
                        <label for="rela1" class="col-form-label col-md-3 col-sm-3 label-align">RelationShip <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="rela1" class="form-control" type="text" name="rela1">
                        </div>
                      </div>
                     
                      <div class="item form-group">
                        <label for="rela2" class="col-form-label col-md-3 col-sm-3 label-align">RelationShip </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="rela2" class="form-control" type="text" name="rela2">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="std_id3" class="col-form-label col-md-3 col-sm-3 label-align">Student ID 3 </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="stdid3" class="form-control" type="text" name="stdid3">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="rela3" class="col-form-label col-md-3 col-sm-3 label-align">RelationShip </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="rela3" class="form-control" type="text" name="rela3">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="std_id4" class="col-form-label col-md-3 col-sm-3 label-align">Student ID 4 </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="stdid4" class="form-control" type="text" name="stdid4">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="rela4" class="col-form-label col-md-3 col-sm-3 label-align">RelationShip </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input id="rela4" class="form-control" type="text" name="rela4">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          ...
                          <button onclick="cStPro();" class="btn btn-success">Submit</button>
                        </div>
                      </div>
