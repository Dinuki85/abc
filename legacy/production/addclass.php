...
?>
	...
	<head>
		...
		<title>Student Enrollment to Class</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Student Registration to a Class</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student To a Class</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="classid">Class ID <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="classid" required="required" class="form-control ">
												</div>
											</div>
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="stindex" required="required" class="form-control">
												</div>
											</div>
										<div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Student Position </label>
											<div class="col-md-6 col-sm-6 ">
											<select name="" id="stposition" class="form-control">
