                    ...
                    <div class="">
                        ...
                        <div class="x_content">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $my = "SELECT * FROM `class` WHERE `id`='$src';";
...
<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="clname" name="class-name" disabled class="form-control" value="<?php echo $item['class_name']; ?>">
											</div>
										</div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <button class="btn btn-danger" type="submit" onclick="deleteClass();">Delete</button>
                                </div>
                            </div>
                        </div>
