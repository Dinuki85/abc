...
?>
    ...
    <head>
        ...
        <title>Student Name List in grade</title>
                                ...
                                <div class="title_right">
                                    <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                                        <div class="input-group">
                                            <input type="text" class="form-control" required id="search" name="search" value="<?php if(isset($_POST['submit'])){    echo $_POST['search']; }?>" placeholder="Search Class ID...">
