...
?>
	...
	<head>
		...
		<title>Co-Curricular Registration </title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Student Registration to a Co-C Activity</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student To a Co-Curricular Activity</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Co-Curricular Activity ID <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="clubid" required="required" class="form-control ">
												</div>
											</div>

											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Student Index No <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="coachid" required="required" class="form-control">
												</div>
											</div>

										<div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Prefect Board Position </label>
											<div class="col-md-6 col-sm-6 ">
											    <select name="" id="gicatagoryd" class="form-control">
													<option value="0">Select a Catergory </option>
													<option value="1">Head Prefect (HP)</option>
													<option value="2">Deputy Head Prefect (DHP)</option>
													<option value="3">Games Captain (GC) </option>
													<option value="4">Senior Prefect </option>
                                                    <option value="5">Junior Prefect </option>
                                                    <option value="6">Projects </option>
												</select>
											</div>
										</div>
                                        <div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Student Parliment Position </label>
											<div class="col-md-6 col-sm-6 ">
											    <select name="" id="gicatagoryd" class="form-control">
													<option value="0">Select a Catergory </option>
                                                    <option value="1">Chief Secretary</option>
													<option value="1">Deputy Chief Secretary - Development</option>
                                                    <option value="1">Deputy Chief Secretary - Administration</option>
                                                    <option value="1">Deputy Chief Secretary - Discipline</option>
                                                    <option value="3">The Speaker</option>
                                                    <option value="2">Prime Minister</option>
                                                    <option value="2">Leader Of the House</option>
                                                    <option value="3">Deputy Speaker</option>
                                                    <option value="3">Deputy Chairman of Commities</option>
                                                    <option value="3">Advisary Commities</option>
													<option value="3">Minister of Student Behavioral Development and studen welfare</option>
                                                    <option value="4">Minister of Student Competencies and Innovations</option>
                                                    <option value="5">Minister of Inter School Goodwill Building and Development</option>
                                                    <option value="6">Minister of Ediucation</option>
                                                    <option value="7">Minister of Cultural & Religious Affaires</option>
                                                    <option value="8">Minister of Socila Reconsilation & Student Sequrity Affaires</option>
                                                    <option value="9">Minister of Development of Community Relationship & Comunity Services</option>
													<option value="10">Minister of Health Nutrition and Sports</option>
                                                    <option value="11">Minister of Agryculture and Environment Development</option>
                                                    <option value="12">Minister of Development of Physical Resourse and Disaster Management</option>
											...
											<div class="item form-group">
												...
												<button onclick="co();" class="btn btn-success">Add</button>
													<button onclick="co();" class="btn btn-success">Update</button>
													<button class="btn btn-danger" type="submit" onclick="deleteStudent();">Delete</button>
												</div>
											</div>
