					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>User <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">User ID <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Password Name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="clname" name="class-name" class="form-control">
											</div>
										</div>

                                        <div class="item form-group">
											<label for="wpday" class="col-form-label col-md-3 col-sm-3 label-align">User Type</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button class="btn btn-success" onclick="createClass();">Submit</button>
											</div>
										</div>
