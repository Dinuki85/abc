					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Trip/ Field Visit Registration</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Trip/ Field Visit  <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="ids">Trip ID <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											<label for="catagory" class="col-form-label col-md-3 col-sm-3 label-align">Trip Type</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="location">Final Destination <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="mpurpose">Main Purpose <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="mpurpose" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="gpurpose">General Purpose <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="gpurpose" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											<label for="gid" class="col-form-label col-md-3 col-sm-3 label-align">Grade</label>
											<div class="col-md-6 col-sm-6 ">
											<select name="" id="gid" class="form-control">
										...
										<div class="item form-group">
											<label for="cid" class="col-form-label col-md-3 col-sm-3 label-align">Class ID</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="cid" class="form-control" type="text" name="cid">
											</div>
										</div>
										<div class="item form-group">
											<label for="tincha" class="col-form-label col-md-3 col-sm-3 label-align">Teacher Incharge ID</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<label for="emno" class="col-form-label col-md-3 col-sm-3 label-align">Depature Time</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="stdindex" class="form-control" type="text" name="stdindex">
											</div>
										</div>
