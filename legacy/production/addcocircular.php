									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Club_id <span class="required">*</span>
												</label>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Coach_id <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">
												<label for="stdindex" class="col-form-label col-md-3 col-sm-3 label-align">Student Index <span class="required">*</span></label>
												<div class="col-md-6 col-sm-6 ">
													<input id="stdindex" class="form-control" type="text" >
												</div>
											</div>
											<div class="item form-group">
												<label for="std_id" class="col-form-label col-md-3 col-sm-3 label-align">Student ID <span class="required">*</span></label>
												<div class="col-md-6 col-sm-6 ">
													<input id="stdid" class="form-control" type="text" >
												</div>
											</div>
											<div class="item form-group">
												<label for="pos" class="col-form-label col-md-3 col-sm-3 label-align">Position <span class="required">*</span></label>
												<div class="col-md-6 col-sm-6 ">
													<input id="pos" class="form-control" type="text" >
												</div>
											</div>
