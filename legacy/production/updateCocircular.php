...
?>
    ...
    <head>
        ...
        <title>Update Co-Curricular </title>
                    ...
                    <div class="">
                        ...
                        <div class="x_content">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $my = "SELECT * FROM `co_curricular` WHERE CONCAT(`club_id`,`coach_id`,`std_index`,`position`) like '%$src%';";
                            ...
                            ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="clubid" required="required" class="form-control " value="<?php echo $item['club_id']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Coach ID<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="clubname" required="required" class="form-control" disabled value="<?php echo $item['coach_id']; ?> ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Student Index <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="inchargeid" required="required" class="form-control" value="<?php $item['std_index'] ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Position </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="leaderid" required="required" class="form-control" value="<?php echo $item['position'] ?>">
                                            </div>
                                        </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <button class="btn btn-success" type="submit" onclick="updateCocircular();">Update</button>
                                </div>
                            </div>
                        </div>
