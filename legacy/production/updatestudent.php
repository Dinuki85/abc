                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Lets Update Student Details</h3>
                            </div>
                        ...
                        <div class="x_content">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $my = "SELECT * FROM `student` WHERE CONCAT(`index`,`full_name`,`initial`,`special_need`,`birthday`,`permenant_address`,`tempory_address`,`emergency_no`,`whatsapp_no`,`home_no`,`mobile_no`) like '%$src%';";
                            ...
                            ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="fullname" class="form-control " value="<?php echo $item['full_name']; ?>" placeholder="<?php echo $item['full_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="Initial" class="col-form-label col-md-3 col-sm-3 label-align">Name with Initial</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="initial" class="form-control" type="text" value="<?php echo $item['initial']; ?>" placeholder="<?php echo $item['initial']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="tadress" class="col-form-label col-md-3 col-sm-3 label-align">Special Need</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="specialneed" class="form-control" type="text" value="<?php echo $item['special_need']; ?>" placeholder="<?php echo $item['special_need']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="padress" class="col-form-label col-md-3 col-sm-3 label-align">Permanent Address</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="paddress" class="form-control" type="text" value="<?php echo $item['permenant_address']; ?>" placeholder="<?php echo $item['permenant_address']; ?>" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="tadress" class="col-form-label col-md-3 col-sm-3 label-align">Tempory Address</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="taddress" class="form-control" type="text" value="<?php echo $item['tempory_address']; ?>" placeholder="<?php echo $item['tempory_address']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="emno" class="form-control" type="text" value="<?php echo $item['emergency_no']; ?>" placeholder="<?php echo $item['emergency_no']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="wtno" class="col-form-label col-md-3 col-sm-3 label-align">Whatsapp No</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="wtno" class="form-control" type="text" value="<?php echo $item['whatsapp_no']; ?>" placeholder="<?php echo $item['whatsapp_no']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="hmno" class="col-form-label col-md-3 col-sm-3 label-align">Home No</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="hmno" class="form-control" type="text" value="<?php echo $item['home_no']; ?>" placeholder="<?php echo $item['home_no']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="sec" class="col-form-label col-md-3 col-sm-3 label-align">Mobile No </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="mbno" class="form-control" type="text" value="<?php echo $item['mobile_no']; ?>" placeholder="<?php echo $item['mobile_no']; ?>">
                                            </div>
                                        </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <button class="btn btn-success" type="submit" onclick="updateStudent();">Update</button>
                                </div>
                            </div>
                        </div>
