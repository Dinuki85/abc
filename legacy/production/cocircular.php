					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Co-Curricular Activities Registration</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Co-Curricular Activities <small>Basic Information</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Club/ Activity ID <span class="required">*</span>
												</label>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Club Name <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="clubname" required="required" class="form-control ">
												</div>
											</div>
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Incharge ID <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="inchargeid" required="required" class="form-control">
												</div>
											</div>
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Leader ID </label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="leaderid" required="required" class="form-control">
												</div>
											</div>
										<div class="item form-group">
											<label for="clday" class="col-form-label col-md-3 col-sm-3 label-align">Weekly Class Day</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="clday" class="form-control">
										...
										<div class="item form-group">
											<label for="emno" class="col-form-label col-md-3 col-sm-3 label-align">Time</label>
											<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">
												<label for="pos" class="col-form-label col-md-3 col-sm-3 label-align">Special Note</label>
												<div class="col-md-6 col-sm-6 ">
													<input id="snote" class="form-control" type="text" >
												</div>
											</div>
											...
											<div class="item form-group">
												<label for="pos" class="col-form-label col-md-3 col-sm-3 label-align">Special Note</label>
												<div class="col-md-6 col-sm-6 ">
													<select name="" class="form-control" id="stdindex">
														<option value="0">Select Student</option>
														<?php
														
														$st= Database::search("SELECT * FROM `student`");
														$st_rows = $st->num_rows;

														for($x=0;$x<$st_rows;$x++){
															$st_rs=$st->fetch_assoc();
															?>

															<option value="<?php echo $st_rs['id'] ?>"><?php echo $st_rs['index'] ;?></option>
											...
											<div class="item form-group">
												<div class="col-md-6 col-sm-6 offset-md-3">
													...
													<button onclick="co();" class="btn btn-success">Submit</button>
												</div>
											</div>
