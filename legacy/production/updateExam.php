                    ...
                    <div class="">
                        ...
                        <div class="x_content">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $my = "SELECT * FROM `exam` WHERE CONCAT(`exam_id`,`school`,`class_id`,`teacher`) like '%$src%';";
                            ...
                            ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_id" class="form-control" type="text" name="exam_id" required="required" disabled value="<?php echo $item['exam_id']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="exam_name" class="col-form-label col-md-3 col-sm-3 label-align">Exam Name <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_name" class="form-control" type="text" name="exam_name" required="required"  value="<?php echo $item['school']; ?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_ins" class="form-control" type="text" name="exam_ins" required="required" value="<?php echo $item['class_id']; ?>"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <label for="exam_ins" class="col-form-label col-md-3 col-sm-3 label-align">Responsible Institute <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_ins" class="form-control" type="text" name="exam_ins" required="required" value="<?php echo $item['teacher']; ?>"> 
                                            </div>
                                        </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <button class="btn btn-success" type="submit" onclick="updateExam();">Update</button>
                                </div>
                            </div>
                        </div>
