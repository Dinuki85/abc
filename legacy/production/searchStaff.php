                                ...
                                <div class="title_right">
                                    <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                                        <div class="input-group">
                                            <input type="text" class="form-control" required id="search" name="search" value="<?php if(isset($_POST['submit'])){    echo $_POST['search']; }?>" placeholder="Search ID...">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $my = "SELECT * FROM `staff` WHERE CONCAT(`id`, `name`, `salary`, `catergory_idcatergory`, `birthday`, `permenant_address`, `tempory_address`, `emergency_no`, `whats_no`, `home_no`, `mobile_no`, `email`      ) like '%$src%';";
                                ...
                                ?>
                                            ...
                                            <?php
                                             ...
                                             $cat = Database::search("SELECT * FROM `catergory` WHERE `idcatergory`='".$item['catergory_idcatergory']."'");
                                             $cat_rows = $cat->num_rows;

                                             for($x=0;$x<$cat_rows;$x++){
                                                $cat_rs=$cat->fetch_assoc();
                                             
                                             
                                             ?>
                                                <td><?php echo $cat_rs['catergory']; ?></td>

                                                <?php 
                                                
                                             }
                                                ?>
                                                    <td><?php echo $item['permenant_address']; ?></td>
                                                    <?php
                                                
                                                    if (!empty($item['tempory_address'])) {
                                                    ?><td><?php echo $item['tempory_address']; ?></td>
                                                        <td><?php echo $item['emergency_no']; ?></td>
                                                        <td><?php echo $item['whats_no']; ?></td>
                                                        <td><?php echo $item['home_no']; ?></td>
