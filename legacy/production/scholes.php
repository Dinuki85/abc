...
?>
	...
	<head>
		...
		<title>Schoollerships Registration</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Scholarships Registration</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Scholarships <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="ids">Scholarship ID <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="sports">Scholarship Name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="scholename" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											<label for="padress" class="col-form-label col-md-3 col-sm-3 label-align">Offering Foundation</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="coachid" class="form-control" type="text" name="coachid">
											</div>
										</div>
										<div class="item form-group">
											<label for="scholeamount" class="col-form-label col-md-3 col-sm-3 label-align">Amount</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="scholeamount" class="form-control" type="text" name="scholeamount">
											</div>
										</div>
										<div class="item form-group">
											<label for="spnote" class="col-form-label col-md-3 col-sm-3 label-align">Special Note</label>
											<div class="col-md-6 col-sm-6 ">
