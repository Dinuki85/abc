...
?>
	...
	<head>
		...
		<title>Add Student to Sport </title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Student Registration to a Sport</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student To a Sport</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="index">Sport ID <span class="required">*</span>
												</label>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											    <select name="" id="gicatagoryd" class="form-control">
													...
													<option value="2">Vise Captain</option>
