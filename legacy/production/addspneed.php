...
?>
	...
	<head>
		...
		<title>Special Need Student Registration</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Special Need Student Registration</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Special Need Student </small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="classid">Student Index No <span class="required">*</span>
												</label>
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Special Need Type<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="class-name">Special Note <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="stindex" required="required" class="form-control">
												</div>
