					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Sport <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="ids">Sports ID <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="sports">Sport Name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<label for="padress" class="col-form-label col-md-3 col-sm-3 label-align">Incharge ID<span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="inchaid" class="form-control" type="text" name="inchaid">
											</div>
										</div>
										<div class="item form-group">
											<label for="padress" class="col-form-label col-md-3 col-sm-3 label-align">Coach ID</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="coachid" class="form-control" type="text" name="coachid">
											</div>
										</div>
										<div class="item form-group">
											<label for="wpday" class="col-form-label col-md-3 col-sm-3 label-align">Weekly Practice Day</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="wpday" class="form-control">
