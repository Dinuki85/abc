                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Exam <small>Basic Information</small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="item form-group">
                                            <label for="exam_id" class="col-form-label col-md-3 col-sm-3 label-align">Exam ID <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_id" class="form-control" type="text" name="exam_id" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="exam_name" class="col-form-label col-md-3 col-sm-3 label-align">Exam Name <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_name" class="form-control" type="text" name="exam_name" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="exam_ins" class="col-form-label col-md-3 col-sm-3 label-align">Responsible Institute <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="exam_ins" class="form-control" type="text" name="exam_ins" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="venue" class="col-form-label col-md-3 col-sm-3 label-align">Exam Venue</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="venue" class="form-control" type="text" name="venue" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">Exam Date </label>
											<div class="col-md-6 col-sm-6 ">
												<input id="exdate" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
                                        ...
                                        <div class="item form-group">
											<label for="extime" class="col-form-label col-md-3 col-sm-3 label-align">Exam Time</label>
											<div class="col-md-6 col-sm-6 ">
                                        ...
                                        <div class="item form-group">
                                            <label for="teacher" class="col-form-label col-md-3 col-sm-3 label-align">Special Note </label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="teacher" class="form-control" type="text" name="teacher" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                ...
                                                <button class="btn btn-success" onclick="createExam();">Submit</button>
                                            </div>
                                        </div>
