...
?>
	...
	<head>
		...
		<title>Student Enrollment to Exam</title>
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								<h3>Student Registration to a Exam</h3>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Add <small>Student To a Exam</small></h2>
									...
									<div class="x_content">
										<br />
											...
											<div class="item form-group">
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="classid">Exam ID <span class="required">*</span>
												</label>
