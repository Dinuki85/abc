					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 ">
								<div class="x_panel">
									<div class="x_title">
										<h2>Staff <small>Basic Information</small></h2>
									...
									<div class="x_content">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="ind">NIC<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="ind" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											<label for="Initial" class="col-form-label col-md-3 col-sm-3 label-align">Name with Initial</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="initial" class="form-control" type="text" name="Initial">
											</div>
										</div>
										<div class="item form-group">
											<label for="gen" class="col-form-label col-md-3 col-sm-3 label-align">Gender</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="gen" class="form-control">
										...
										<div class="item form-group">
											<label for="salary" class="col-form-label col-md-3 col-sm-3 label-align">Basic Salary</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="salary" class="form-control" type="text" name="salary">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="Catergory">Employment Catergory <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="clr" class="form-control">
													<option value="0">Select Catergory</option>
													<option value="1">Academic</option>
													<option value="2">Non Academic</option>
													<?php
													$cat = Database::search("SELECT * FROM `catergory`");
													$cat_n = $cat->num_rows;
													...
													?>
														...
														<option value="<?php echo $cat_data['idcatergory']; ?>" class=""><?php echo $cat_data['catergory']; ?></option>
													<?php
													}
													?>
												</select>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="Catergory">Posission <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="clr" class="form-control">
													<option value="0">Select Posission</option>
													<option value="1">Prinsipal</option>
													<option value="2">Wise Prinsipal</option>
													<option value="3">Assistant Prinsipal</option>
													<option value="4">Teacher</option>
													<option value="5">Teacher Assistant</option>
													<option value="6">Lab Assistant</option>
													<option value="7">Librarian</option>
													<option value="8">Couch</option>
													<option value="9">Development Officer</option>
													<option value="10">Office Assistant</option>
										...
										<div class="item form-group">
											<label for="nation" class="col-form-label col-md-3 col-sm-3 label-align">Nationality</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="nat" class="form-control">
													<option value="0">Select Catergory</option>
										...
										<div class="item form-group">
											<label for="religeon" class="col-form-label col-md-3 col-sm-3 label-align">Religeon</label>
											<div class="col-md-6 col-sm-6 ">
												<select name="" id="rel" class="form-control">
													<option value="0">Select Catergory</option>
													<option value="1">Buddhist</option>
													<option value="2">Roman Cathalic</option>
										...
										<div class="item form-group">
											<label for="padress" class="col-form-label col-md-3 col-sm-3 label-align">Permanent Address</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="paddress" class="form-control" type="text" name="Permenar-address">
											</div>
										</div>
										<div class="item form-group">
											<label for="tadress" class="col-form-label col-md-3 col-sm-3 label-align">Residential Address</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="taddress" class="form-control" type="text" name="Tempory-address">
											</div>
										</div>

										<div class="item form-group">
											<label for="emno" class="col-form-label col-md-3 col-sm-3 label-align">Emergency Contact No</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="emno" class="form-control" type="text" >
											</div>
										</div>
										<div class="item form-group">
											<label for="wtno" class="col-form-label col-md-3 col-sm-3 label-align">Whatsapp No</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="wtno" class="form-control" type="text" >
											</div>
										</div>
										<div class="item form-group">
											<label for="hmno" class="col-form-label col-md-3 col-sm-3 label-align">Home Landline No</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="hmno" class="form-control" type="text">
											</div>
										</div>
										<div class="item form-group">
											<label for="mbno" class="col-form-label col-md-3 col-sm-3 label-align">Mobile No</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="mbno" class="form-control" type="text">
											</div>
										</div>
										<div class="item form-group">
											<label for="mbno" class="col-form-label col-md-3 col-sm-3 label-align">Email</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="em" class="form-control" type="text"\">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button class="btn btn-success" onclick="createStaff();">Submit</button>
											</div>
										</div>
