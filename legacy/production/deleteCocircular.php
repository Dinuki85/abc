...
?>
    ...
    <head>
        ...
        <title>Delete Co-Curricular</title>
                    ...
                    <div class="">
                        ...
                        <div class="x_content">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $my = "SELECT * FROM `co_curricular` WHERE `club_id`='$src';";
                            ...
                            ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="leaderid" required="required" class="form-control" disabled value="<?php echo $item['position'] ?>">
                                            </div>
                                        </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <button class="btn btn-danger" type="submit" onclick="deleteCocircular();">Delete</button>
                                </div>
                            </div>
                        </div>
